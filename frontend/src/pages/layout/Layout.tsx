...
const shareButtonStyles: ICommandBarStyles & IButtonStyles = {
    root: {
      ...
      height: 32,
      borderRadius: 4,
      background: 'radial-gradient(109.81% 107.82% at 100.1% 90.19%, #bd2916 33.63%, #bd2916 70.31%, #e9713e 100%)',
    //   position: 'absolute',
    //   right: 20,
      padding: '5px 12px',
      marginRight: '20px'
    ...
    rootHovered: {
      background: 'linear-gradient(135deg, #bd2916 0%, #bd2916 51.04%, #e9713e 100%)',
    },
    label: {
      fontWeight: 600,
      fontSize: 14,
