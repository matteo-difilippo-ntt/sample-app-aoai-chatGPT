...
import TNTData from "../../assets/TNTData.png"
            ...
            {showAuthMessage ? (
                <Stack className={styles.chatEmptyState}>
                    ...
                    <h2 className={styles.chatEmptyStateSubtitle}>
                        This apppp does not have authentication configured. Please add an identity provider by finding your app in the 
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Ciao! 👋🏻 Come posso aiutarti?</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Non essere timido! Fai una domanda e avrai la risposta che cerchi.</h2>
                            </Stack>
                        ) : (
                            ...
                            <Stack>
                                {appStateContext?.state.isCosmosDBAvailable?.status !== CosmosDBStatus.NotConfigured && <CommandBarButton
                                    ...
                                    styles={{ 
                                        ...
                                        root: {
                                            color: '#FFFFFF',
                                            background: "radial-gradient(109.81% 107.82% at 100.1% 90.19%, #e9713e 33.63%, #e9713e 70.31%, #e9713e 100%)"
                                        },
                                        rootDisabled: {
                                            background: "#BDBDBD"
                                        }
                                ...
                                <CommandBarButton
                                    ...
                                    styles={{ 
                                        ...
                                        root: {
                                            color: '#FFFFFF',
                                            background: disabledButton() ? "#BDBDBD" : "radial-gradient(circle, rgba(189,41,22,1) 0%, rgba(233,113,62,1) 100%);",
